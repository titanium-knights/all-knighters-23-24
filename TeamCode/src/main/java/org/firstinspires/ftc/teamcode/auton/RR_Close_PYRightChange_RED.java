...
@Autonomous(name = "51 - C_RED - PY_RightChange", group = "Linear OpMode")
@Config

public class RR_Close_PYRightChange_RED extends LinearOpMode{
    ...
    public static Pose2d PURPLE_CENTER_RIGHT = new Pose2d(27, -22, Math.toRadians(0));
